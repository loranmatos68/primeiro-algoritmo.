...
# Aqui você determina a alíquota base e a dedução utilizando a Tabela Progressiva
if salario <= 2428.80:
    aliquota = 0.0
    deducao = 0.0
...
# Caso o imposto base for negativo, ele deve ser arredondado para zero
if imposto_base < 0:
    imposto_base = 0.0

# Aplique a Nova Regra de Isenção da lei que será vigente para 2026
if salario <= 5000.00:
    imposto_final = 0.0
